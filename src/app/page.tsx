...
const DRIVER_POOL: DriverInfo[] = [
  {
    ...
    stats: { pace: 98, consistency: 97, tyreManagement: 96 },
    wage: 25,
    morale: 88,
    contractRounds: 18,
  },
  {
    ...
    stats: { pace: 96, consistency: 93, tyreManagement: 91 },
    wage: 22,
    morale: 90,
    contractRounds: 18,
  },
  {
    ...
    nationality: "Monaco",
    stats: { pace: 95, consistency: 92, tyreManagement: 91 },
    wage: 22,
    morale: 86,
    contractRounds: 18,
  },
  {
    ...
    stats: { pace: 95, consistency: 91, tyreManagement: 90 },
    wage: 21,
    morale: 89,
    contractRounds: 20,
  },
  {
    ...
    name: "George Russell",
    nationality: "United Kingdom",
    stats: { pace: 93, consistency: 91, tyreManagement: 89 },
    wage: 18,
    morale: 84,
    contractRounds: 18,
  },
  ...
  },
  {
    ...
    name: "Carlos Sainz",
    nationality: "Spain",
    stats: { pace: 91, consistency: 90, tyreManagement: 92 },
    wage: 18,
    morale: 83,
    contractRounds: 16,
  },
  {
    ...
    nationality: "Spain",
    stats: { pace: 90, consistency: 94, tyreManagement: 97 },
    wage: 17,
    morale: 80,
    contractRounds: 12,
  },
  {
    ...
    nationality: "Italy",
    stats: { pace: 89, consistency: 85, tyreManagement: 84 },
    wage: 11,
    morale: 81,
    contractRounds: 24,
  },
  {
    ...
    stats: { pace: 88, consistency: 87, tyreManagement: 86 },
    wage: 12,
    morale: 81,
    contractRounds: 18,
  },
  {
    ...
    name: "Pierre Gasly",
    nationality: "France",
    stats: { pace: 87, consistency: 85, tyreManagement: 85 },
    wage: 11,
    morale: 78,
    contractRounds: 18,
  },
  {
    ...
    name: "Esteban Ocon",
    nationality: "France",
    stats: { pace: 86, consistency: 84, tyreManagement: 84 },
    wage: 10,
    morale: 77,
    contractRounds: 16,
  },
  {
    ...
    name: "Yuki Tsunoda",
    nationality: "Japan",
    stats: { pace: 86, consistency: 82, tyreManagement: 82 },
    wage: 10,
    morale: 79,
    contractRounds: 17,
  },
  {
    ...
    name: "Lance Stroll",
    nationality: "Canada",
    stats: { pace: 84, consistency: 81, tyreManagement: 82 },
    wage: 9,
    morale: 74,
    contractRounds: 18,
  },
  {
    ...
    nationality: "Germany",
    stats: { pace: 85, consistency: 89, tyreManagement: 90 },
    wage: 10,
    morale: 77,
    contractRounds: 15,
  },
  {
    ...
    name: "Oliver Bearman",
    nationality: "United Kingdom",
    stats: { pace: 84, consistency: 81, tyreManagement: 80 },
    wage: 8,
    morale: 79,
    contractRounds: 24,
  },
  ...
  },
  {
    ...
    name: "Isack Hadjar",
    nationality: "France",
    stats: { pace: 83, consistency: 80, tyreManagement: 79 },
    wage: 7,
    morale: 80,
    contractRounds: 24,
  },
  {
    ...
    stats: { pace: 84, consistency: 81, tyreManagement: 81 },
    wage: 8,
    morale: 81,
    contractRounds: 22,
  },
  {
    ...
    name: "Arvid Lindblad",
    nationality: "United Kingdom",
    stats: { pace: 83, consistency: 79, tyreManagement: 78 },
    wage: 7,
    morale: 84,
    contractRounds: 26,
  },
